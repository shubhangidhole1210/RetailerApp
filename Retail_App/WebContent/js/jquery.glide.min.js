(function(e, t, n, r) {
	...
	function u(e) {
		var i = false, s = "Khtml ms O Moz Webkit".split(" "), o = n
				.createElement("div"), u = null;
		e = e.toLowerCase();
		if (o.style[e] !== r)
			i = true;
		if (i === false) {
	...
	o.prototype.navigation = function() {
		...
		if (t.slides.length > 1) {
			var n = t.options, r = t.options.nav === true ? t.parent
					: t.options.nav;
			t.navWrapper = e("<div />", {
				"class" : n.navClass
			}).appendTo(r);
	...
	o.prototype.arrows = function() {
		var t = this;
		if (t.slides.length > 1) {
			var n = t.options, r = t.options.arrows === true ? t.parent
					: t.options.arrows;
	...
	o.prototype.slide = function(e, t, n) {
		...
		if (r.options.nav && r.navWrapper) {
			r.navWrapper.children().eq(-i).addClass(o).siblings()
					.removeClass(o)
		}
		r.currentSlide = i;
